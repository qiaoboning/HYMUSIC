...
__DEFINE__(1642847706201, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642847706202,"./event-store":1642847706203}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642847706202, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642847706203, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642847706202,"./utils":1642847706204}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642847706204, function(require, module, exports) {
...
return __REQUIRE__(1642847706201);
})()
